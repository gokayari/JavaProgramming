...
public class UniqueCharacters {     //Important!
    ...
    public static void main(String[] args) {
        ...
        //Step 1: how to find frequency of one character:
        /*
            char ch = 'a';
            int count = 0;
         ...
         */
        //Step 2: to find frequency of each character:
        /*
        for (int j = 0; j < str.length(); j++) {
            char ch = str.charAt(j);
         ...
         */
        //Step 3: the character is unique: (in the outer loop)
        /*
        if (count == 1){
                result += ch;
            }
