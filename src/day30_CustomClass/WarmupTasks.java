...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        Collections.swap(numbers, 0, numbers.size()-1);     //[8, 2, 3, 4, 5, 6, 7, 1]
        ...
        specialChar.removeIf( p -> Character.isLetterOrDigit(p));   //remove the characters that are letters or digits
