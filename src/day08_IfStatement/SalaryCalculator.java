...
3. Create a class called SalaryCalculator.java
			...
			3.3 use print statement to print each of the above
				Ex:
					   hourlyRate = $50
					   weeklyHours = 45
					   stateTaxRate = 6.5 (given as percentage, you need to convert to decimal)
					   federalTaxRate = 26.2 (given as percentage, you need to convert to decimal)

				    output:
				    	Gross pay is: $117000
				    	Federal tax is: $30654
			    		State tax is: $7605
			    		Total tax is: $38259
			    		Net income is: 78741
 */