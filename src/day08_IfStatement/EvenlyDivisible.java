...
public class EvenlyDivisible { //(:esit olarak bölünebilen)

    public static void main(String[] args) {

        int number = 65;

        boolean divisibleBy2 = number % 2 == 0; // if the remainder of a divide by 2 is zero, then it is evenly divisible by 2
