...
public class Castings {
    ...
    public static void main(String[] args) {
        ...
        // int num3 = (short) averageScore;>>> this is also correct because "int" bigger then "short"
        long num4 = (long) averageScore;
        // long num4 = (int) averageScore;>>> this is also correct because "long" bigger then "int"
        float num5 = averageScore; // NO casting!*
        double num6 = averageScore; // implicit casting**
        // double num6 = (double) averageScore;>>> that is also correct but not necessary
