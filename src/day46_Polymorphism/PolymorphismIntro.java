...
public class PolymorphismIntro {
    ...
    public static void main(String[] args) {
        ...
        employee.work();
        //employee.bugReport();     //bugReport reference type is not for all of employee
        ...
        animal.drink();
        animal.eat();
        //animal.play();    //play reference type is not for all of animal
        ...
        boolean isTriangle = shape instanceof Triangle;     //false
