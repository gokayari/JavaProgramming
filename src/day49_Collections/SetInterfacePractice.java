...
public class SetInterfacePractice {
    ...
    public static void main(String[] args) {
        ...
        //  System.out.println( hashSet.get(4) );   //hashSet does not have index!
        ...
        treeSet.addAll(Arrays.asList(10,200,300,40,90));
        treeSet.addAll(Arrays.asList(10,200,300,40,90));
        // treeSet.addAll(Arrays.asList(null,null,null));   //treeSet does not accept 'null'
                                    //=NullPointerException

        System.out.println("treeSet = " + treeSet);     //sorted (Ascending) order
