    ...
    public static void main(String[] args) {
        ...
        */
        ...
        list.removeIf( p -> p<5);       //Lambda Expression
                                //all the elements less than 5 are removed
        System.out.println(list);
        ...
        list2.removeIf( each -> each%2 ==0);    //even numbers are removed
        ...
        names.removeIf( name -> StringUtility.isPalindrome(name));  //from StringUtility class
