...
public class UniqueElements {
    ...
    public static void main(String[] args) {
        ...
        char[] array3 = {'a', 'a', 'b', 'c', 'd', 'd'};

        char[] unique3 = uniqueElements(array3);
        System.out.println(Arrays.toString(unique3));   //{'b', 'c'}

        System.out.println("--------------");

        String[] array4 = {"Java", "Python", "Java", "Java", "C++", "Java"};

        String[] unique4 = uniqueElements(array4);
        System.out.println(Arrays.toString(unique4));   //{"Python", "C++"}
