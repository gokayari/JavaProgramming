...
public class FrequencyOfElement {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {1,1,1,11,1,1,2,2,3,3,4,1,1,4,1,4,5,5};
        ...
        String[] names = {"Java", "Python", "Java", "Java", "Python", "C++", "C++", "Java"};
        int n1 = frequencyOfElement(names, "Java");

        System.out.println("n1 = " + n1);   //4
    }

    //returns the frequency of the given element from the give array
