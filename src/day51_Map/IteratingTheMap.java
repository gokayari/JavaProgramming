...
public class IteratingTheMap {
    ...
    public static void main(String[] args) {
        ...
        //the students whose score is less than 90
        ...
        int max = Collections.max(students.values());   //max number without using loop
        int min = Collections.min(students.values());   //min number without using loop
