...
public class SentenceSplit {
    ...
    public static void main(String[] args) {
        ...
        String[] each = searchResult.split(" ");    //split: to divide
        ...
        // confirmation.split("\n") --> array
        /* confirmation.split("\n")[1] -> the second element in the
        array, so it is string, so I can split again, and provide index
        of second element I get amount
         */
